  ...
  return (
    <>
      <footer id="contact" className="pb-5 h-[50vh] border-t-1 border-black ">
        ...
        <div className="flex justify-evenly items-center w-4/5 mx-auto mt-10 p-10">
          <h2 className="text-xl bg-white p-5 rounded-2xl shadow-lg font-semibold">Rejoins-nous !</h2>
          <h2 className="text-xl bg-white p-5 rounded-2xl shadow-lg font-semibold"> <a href="https://www.paypal.com/be/home?locale.x=fr_BE">Soutient-nous</a></h2>
          <h2 className="text-xl bg-white p-5 rounded-2xl shadow-lg font-semibold"><a href="/contact">Contactes-nous</a></h2>
